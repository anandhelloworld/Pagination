...
const data_element=document.getElementById('table');
const pagination_element=document.getElementById('moving');

let current_page=1;
let rows=10;

function display_list(data,wrapper,rows_per_page,page ){
  ...
  for(let i=0;i<paginateditems.length;i++){
    ...
    const row = data_element.insertRow();
...
function SetupPagination(items,wrapper,rows_per_page){
  ...
  prev.addEventListener("click",()=>{
    ...
    display_list(data,data_element,rows,current_page);
    })
